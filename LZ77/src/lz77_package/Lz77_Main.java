...
import static lz77_package.txtReader.cargarTxt;
import static lz77_package.txtReader.ASCIIbin2string;
...
public class Lz77_Main {
    ...
    public static void main(String[] args) {
        ...
        if (!configControl(Ment, Mdes, entrySize)) {
            ...
            String compressed_bits = lz77.compress(bits.toString());
